  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: HugeIcon(icon: HugeIcons.strokeRoundedTick02, color: const Color(0xFF388E3C), size: 24.0),
            onPressed: () {
      ...
      floatingActionButton: FloatingActionButton(
        ...
        child: HugeIcon(icon: HugeIcons.strokeRoundedGps01, color: Colors.white, size: 24.0),
        onPressed: () {
