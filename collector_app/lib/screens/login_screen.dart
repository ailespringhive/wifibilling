...
class _LoginScreenState extends State<LoginScreen> with SingleTickerProviderStateMixin {
  ...
  Widget _build3DTitle() {
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        // Continuous wave 0 -> 1 smoothly over 2.4s
        ...
        return Transform(
          ...
          transform: Matrix4.identity()
            ...
            ..multiply(Matrix4.identity()..setEntry(0, 1, math.tan(-10 * math.pi / 180))), // Native SkewX logic equivalent to CSS skewX(-10deg)
          child: SizedBox(
            width: 280,
            height: 70,
            child: Stack(
              ...
              children: [
                Positioned(
                   ...
                   child: Text(text, style: textStyle.copyWith(color: const Color(0xFFFF4D4D))),
                ),
                Positioned(
                ...
                Positioned(
                   ...
                   top: getWave(0.0) * -6.0,
                   child: Text(text, style: textStyle.copyWith(color: const Color(0xFF00D9FF))),
                ),
              ],
            ),
          ),
      ...
      children: [
        ...
        AnimatedContainer(
          ...
          decoration: BoxDecoration(
            color: focusNode.hasFocus ? Colors.white : Colors.white.withValues(alpha: 0.9),
            borderRadius: BorderRadius.circular(30),
            border: Border.all(
              color: focusNode.hasFocus ? const Color(0xFF1A1A1A) : Colors.grey.shade300,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xFFE0E3E8), // Softer, darker cool gray
      body: SafeArea(
        child: Center(
          child: SingleChildScrollView(
            ...
            children: [
              ...
              // HTML/CSS Generated 3D Animation Title Block
              Center(child: _build3DTitle()),
              
              const SizedBox(height: 32),
              Text(
                'Sign in to continue to WiFi Collector',
                style: GoogleFonts.inter(
                  fontSize: 15,
                  color: Colors.grey.shade600,
                ),
                    ...
                    onPressed: () {
                      showDialog(
                        ...
                        builder: (context) => AlertDialog(
                          ...
                          content: Text('Please contact the Administrator to reset your password.', style: GoogleFonts.inter()),
                          actions: [
                            TextButton(
              ...
              // Error message and Button wrapped in Consumer
                ...
                builder: (context, auth, _) {
                  return Column(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTapDown: (_) {
                          if (!auth.isLoading) setState(() => _isButtonPressed = true);
                        },
                        onTapUp: (_) {
                        ...
                        child: AnimatedContainer(
                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: _isButtonPressed
                                ? []
                                : [BoxShadow(color: Colors.black.withValues(alpha: 0.15), spreadRadius: 0, blurRadius: 10, offset: const Offset(0, 4))],
                          ),
                          child: Center(
