...
async function createAdminUser() {
  console.log('\n👤 Creating permanent admin user...');
  
  const user = await api('POST', '/users', {
    userId: 'admin001',
    email: 'junriladmin@admin.com',
    password: 'Password123!',
    name: 'Junril Administrator',
  });
  
  if (user) {
    console.log('  ✓ User created: junriladmin@admin.com / Password123!');
  }
...
async function main() {
  ...
  await createCollection('users_profile', 'Users Profile', [
    ...
    { key: 'billingStartDate', type: 'string', size: 50, required: false },
  ]);
  ...
  // 4. Seed demo data (Disabled per request)
  // await seedDemoData();

  console.log('\n🎉 Setup complete!');
  console.log('================================');
  console.log('Login credentials permanently set:');
  console.log('  Email:    junriladmin@admin.com');
